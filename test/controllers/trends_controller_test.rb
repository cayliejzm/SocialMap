...
class TrendsControllerTest < ActionController::TestCase
  ...
  test "should create trend" do
    assert_difference('Trend.count') do
      post :create, trend: { location: @trend.location, name: @trend.name, tweet_volume: @trend.tweet_volume }
    end
  ...
  test "should update trend" do
    patch :update, id: @trend, trend: { location: @trend.location, name: @trend.name, tweet_volume: @trend.tweet_volume }
    assert_redirected_to trend_path(assigns(:trend))
  end
